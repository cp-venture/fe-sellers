...
import ProductDetail from "../fe-prod/src/reaction/components/ProductDetail";
...
import fetchCatalogProduct from "../fe-prod/src/reaction/staticUtils/catalog/fetchCatalogProduct";
