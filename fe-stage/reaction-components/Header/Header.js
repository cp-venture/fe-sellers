...
import { NavigationDesktop } from "reaction-components/NavigationDesktop";
import { NavigationMobile, NavigationToggleMobile } from "reaction-components/NavigationMobile";
import LocaleDropdown from "reaction-components/LocaleDropdown";
import AccountDropdown from "reaction-components/AccountDropdown";
import ShopLogo from "@reactioncommerce/reaction-components/ShopLogo/v1";
import Link from "reaction-components/Link";
import MiniCart from "reaction-components/MiniCart";

const styles = (theme) => ({
  appBar: {
    background: theme.palette.reaction.white,
