...
import { withComponents } from "@reactioncommerce/reaction-components-reaction-contexts";
import { addTypographyStyles, applyTheme, CustomPropTypes } from "@reactioncommerce/reaction-components/utils";
import { priceByCurrencyCode } from "@reactioncommerce/reaction-components/CatalogGridItem/v1/utils";
import Link from "reaction-components/Link";

const ProductMediaWrapper = styled.div`
  background: ${applyTheme("CatalogGridItem.mediaBackgroundColor")};
  position: relative;
`;
...
class CatalogGridItem extends Component {
  static propTypes = {
    ...
    /**
     * If you've set up a components reaction-contexts using
     * [@reactioncommerce/components-reaction-contexts](https://github.com/reactioncommerce/components-context)
     * (recommended), then this prop will come from there automatically. If you have not
     * set up a components reaction-contexts or you want to override one of the components in a
