...
export default envalid.cleanEnv(process.env, {
  ...
  OAUTH2_IDP_PUBLIC_CHANGE_PASSWORD_URL: str({
    ...
    example: "http://18.158.71.6:4100/account/change-password?email=EMAIL&from=FROM"
  }),
